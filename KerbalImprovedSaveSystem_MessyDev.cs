...
//					}
		...
		private void InitStyles()
		{
			...
			//var iconStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("KerbalImprovedSaveSystem.icons.settings.png").readtoend();
			//_settingsTexture.LoadImage(iconStream);
			//_settingsTexture.Apply();
