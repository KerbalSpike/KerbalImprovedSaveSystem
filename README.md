...
* you have to disable Capslock before assigning a new key.
* on international keyboards, you have to hit the accent keys twice(like " ´ " and " ^ " on the German keyboard), because they do not produce a character when hit for the first time, but I need the character to label the key correctly.
...
KISS on [SpaceDock] (http://spacedock.info/mod/583/Kerbal%20Improved%20Save%20System)
